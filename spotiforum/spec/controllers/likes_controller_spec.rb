...
RSpec.describe LikesController, type: :controller do
	describe "POST create" do
		...
		before do
			@user1 = User.create!(name: 'Utente1', email: 'u1@mail.com', spotify: false, song: nil, google: false, password: '123456')
			@user2 = User.create!(name: 'Utente2', email: 'u2@mail.com', spotify: false, song: nil, google: false, password: '123456')
